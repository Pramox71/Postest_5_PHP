...
<body>
    ...
    <div class="kotak_tambah">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="nama" class="form_tambah" placeholder="<?php echo $kapal['Nama_Kapal']?>">
    
            <label>Jenis Kapal</label>
            <input type="text" name="jenis" class="form_tambah" placeholder="<?php echo $kapal['Jenis']?>">

            <label>Jumlah ABK</label>
            <input type="number" name="banyak_abk" class="form_tambah" placeholder="<?php echo $kapal['Jumlah_ABK']?>">

            <label>Tahun Masuk</label>
            <input type="number" name="tahun" class="form_tambah" placeholder="<?php echo $kapal['Tahun_Masuk']?>">
